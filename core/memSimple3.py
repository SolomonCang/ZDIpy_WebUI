...
#
# This module is the ZDI adapter layer on top of the generic MEM engine
# in core/mem_generic.py.  It preserves the original public API so that
# callers (mainFuncs.py, zdi_runner.py) require no changes.
#
# ZDI-specific code (three-form entropy, spherical-harmonic packing, etc.)
# lives here.  Pure MEM algorithm code lives in mem_generic.py.
#
